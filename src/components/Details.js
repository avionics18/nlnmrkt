...
export default class Details extends Component {    
    ...
    increase = () => {
        ...
        const price = this.props.eachProduct.price;
    ...
    render() {
        return (
            <div className="px-3 py-5">
                ...
                {(Object.keys(this.props.eachProduct).length === 0) ? 
                    ...
                    <div className="card border-0 shadow mt-3 rounded-lg">
                        <div className="card-body d-flex justify-content-between">
                            <h5 className="text-dk font-weight-bold">{this.props.eachProduct.name}</h5>
                            <h5 className="text-muted font-weight-bold">Rs. {this.props.eachProduct.price} <small>/ KG</small></h5>
                        </div>
                        <img className="rounded-0 card-img" src={this.props.eachProduct.img2} alt="banana" />
                        <div className="px-4 mb-3 mt-3">
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <div className="counter d-flex justify-content-between align-items-center border rounded-pill overflow-hidden shadow-sm">
                                    ...
                                    <p className="m-0 text-dk font-weight-bold" id="item-no">{this.props.eachProduct.buyKG}</p>
